...
6. <img src="images/storyboarder-24.png" style="float:right;width:200px" alt="print or export to PDF button"> You can export by going to File and then Print or export to PDF to create a printout or PDF pages of your storyboard. From there, you can select the layout preferences you want and see a preview. <img src="images/storyboarder-25.png" style="float:right;width:200px" alt="print menu">
