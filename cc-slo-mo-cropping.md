...
5.  **Drag** the bike video you just imported from the **Project Library** to the **Timeline** at the bottom of the Video Editor window:
    <img src="images/drag-slo" style="float:right;width:180px;" alt="Drag">
...
<img src="images/split-slo" style="float:right;width:180px;" alt="Split">
